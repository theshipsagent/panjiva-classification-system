...
- Panjiva exports: 00_DATA/00.02_PREPROCESSED/01.01_annual_files/panjiva_exports_2023_PORTCALL_*.csv
- USACE clearance: 00_DATA/00.03_MATCHED/usace_2023_clearance_with_panjiva_match_v1.0.0.csv
...
EXPORT_DIR = Path(r"G:\My Drive\LLM\project_manifest\00_DATA/00.02_PREPROCESSED\01.01_annual_files")
CLEARANCE_FILE = Path(r"G:\My Drive\LLM\project_manifest\00_DATA/00.03_MATCHED\usace_2023_clearance_with_panjiva_match_v1.0.0.csv")

OUTPUT_EXPORT_DIR = EXPORT_DIR
OUTPUT_CLEARANCE_FILE = Path(r"G:\My Drive\LLM\project_manifest\00_DATA/00.03_MATCHED\usace_2023_clearance_with_panjiva_match_v1.0.1.csv")
