...
USACE_PATHS = [
    ...
    BASE_DIR / "00_DATA/00.02_PREPROCESSED" / "usace_vessel_entrances",
    BASE_DIR / "00_DATA/00.02_PREPROCESSED" / "usace",
]
...
def find_file(filename):
    ...
    search_paths = [
        BASE_DIR / filename,
        BASE_DIR / "03_DOCUMENTATION/03.04_summaries" / filename,
        BASE_DIR / "00_raw_data" / filename,
        BASE_DIR / "00_DATA/00.02_PREPROCESSED" / filename,
    ]
