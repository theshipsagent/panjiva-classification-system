"""
Stage 5: HS4 Statistical Alignment
===================================
Apply HS4 statistical inference rules.

Input:  panjiva_ALL_YEARS_stage4.csv
Output: panjiva_ALL_YEARS_stage5.csv
"""
import pandas as pd
...
HS4_RULES = BASE_DIR / "CLASSIFICATION_DICTIONARY_HS4_ALIGNMENT.csv"
INPUT_FILE = BASE_DIR / "00_DATA" / "00.03_MATCHED" / "panjiva_ALL_YEARS_stage4.csv"
OUTPUT_FILE = BASE_DIR / "00_DATA" / "00.03_MATCHED" / "panjiva_ALL_YEARS_stage5.csv"
...
def apply_hs4_alignment():
    stamp("="*80)
    stamp("STAGE 5: HS4 STATISTICAL ALIGNMENT")
    stamp("="*80)
    start = datetime.now()
    ...
    stamp(f"\nSTAGE 5 COMPLETE - Duration: {duration:.1f} minutes")
