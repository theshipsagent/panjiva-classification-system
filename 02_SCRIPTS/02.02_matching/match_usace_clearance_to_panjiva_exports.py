...
Input:
- USACE: 00_DATA/00.03_MATCHED/usace_2023_outbound_clearance_transformed_v2.2.0.csv
- Panjiva: 00_DATA/00.02_PREPROCESSED/01.01_annual_files/panjiva_exports_2023_PORTCALL_*.csv

Output: 00_DATA/00.03_MATCHED/usace_2023_clearance_with_panjiva_match_v1.0.0.csv
"""
...
# File paths
USACE_FILE = Path(r"G:\My Drive\LLM\project_manifest\00_DATA/00.03_MATCHED\usace_2023_outbound_clearance_transformed_v2.2.0.csv")
PANJIVA_DIR = Path(r"G:\My Drive\LLM\project_manifest\00_DATA/00.02_PREPROCESSED\01.01_annual_files")
OUTPUT_FILE = Path(r"G:\My Drive\LLM\project_manifest\00_DATA/00.03_MATCHED\usace_2023_clearance_with_panjiva_match_v1.0.0.csv")
