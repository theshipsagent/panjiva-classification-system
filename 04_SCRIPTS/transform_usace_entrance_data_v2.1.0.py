"""
Transform USACE Entrance/Clearance Data v2.1.0
...
def main():
    ...
    OUTPUT_FILE = Path(r"G:\My Drive\LLM\project_manifest\02_STAGE02_CLASSIFICATION\usace_2023_inbound_entrance_transformed_v2.2.0.csv")
